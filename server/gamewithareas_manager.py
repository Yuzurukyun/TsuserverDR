...
class _GameWithAreasTrivialInherited(_Game):
    ...
    def get_numerical_id(self) -> int:
        """
        Return the numerical portion of the ID of this game with areas.
    ...
    def get_name(self) -> str:
        """
        Get the name of the game with areas.
    ...
    def set_name(self, name: str):
        """
        Set the name of the game with areas.
...
class _GameWithAreas(_GameWithAreasTrivialInherited):
    ...
    def get_type_name(self) -> str:
        """
        Return the type name of the game with areas. Names are fully lowercase.
        ...
        -------
        str
            Type name of the game with areas.
...
class GameWithAreasManager(_GameWithAreasManagerTrivialInherited):
    ...
    def get_managees_in_area(self, area: AreaManager.Area) -> Set[_GameWithAreas]:
        """
        Return (a shallow copy of) all games with areas managed by this manager that contain
        the given area.
        ...
        -------
        Set[_GameWithAreas]
            Games with areas that contain the given area.
